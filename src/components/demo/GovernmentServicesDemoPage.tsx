...
function GovernmentServicesApplicationFlow({
  ...
  const translations = getLocalizedRecord(
    GOVERNMENT_SERVICES_DEMO_PAGE_TRANSLATIONS,
    language as keyof typeof GOVERNMENT_SERVICES_DEMO_PAGE_TRANSLATIONS,
    'GOVERNMENT_SERVICES_DEMO_PAGE_TRANSLATIONS',
  );
...
interface GovernmentServicesDemoPageProps {
  onBackToList: () => void;
}

interface GovernmentServicesDemoStep {
  label: string;
  action: string;
  logText: string;
}

interface GovernmentServicesDemoCopy {
  id: DemoScenarioId;
  tag: string;
  title: string;
  desc: string;
  ...
  steps: GovernmentServicesDemoStep[];
}

interface GovernmentServicesDemoScenario extends GovernmentServicesDemoCopy {
...
export default function GovernmentServicesDemoPage({ onBackToList }: GovernmentServicesDemoPageProps) {
  const { language } = useLanguage();
  const translations = getLocalizedRecord(
    GOVERNMENT_SERVICES_DEMO_PAGE_TRANSLATIONS,
    language as keyof typeof GOVERNMENT_SERVICES_DEMO_PAGE_TRANSLATIONS,
  ...
  const scenario = useMemo<GovernmentServicesDemoScenario>(() => ({
    ...translations.meta,
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="bg-white rounded-[32px] border border-slate-200/80 shadow-xl overflow-hidden relative">
              ...
              <div className="p-6 md:p-8 min-h-[480px] bg-slate-50/50 flex flex-col justify-between">
                <GovernmentServicesApplicationFlow
