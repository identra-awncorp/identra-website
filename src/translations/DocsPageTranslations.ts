...
translatePages('vi', {
  ...
  'api-reference': { title: 'Tham chiếu API', sections: {
    'api-lifecycle-overview': { title: 'Tổng quan vòng đời', blocks: [{ type: 'p', text: 'Theo dõi toàn bộ vòng đời SDK: tạo khóa, công bố Tài liệu DID, phát hành thực chứng, lưu vào ví định tín, trình thực chứng và trả kết quả xác minh.' }] },
    identity: { title: 'Nền tảng định danh và khóa', blocks: [{ type: 'p', text: 'Tạo khóa an toàn, công bố Tài liệu DID và chuẩn bị định danh cho bên phát hành, bên nắm giữ và bên xác minh trước khi trao đổi thực chứng.' }] },
    issuance: { title: 'Phát hành và lưu thực chứng', blocks: [{ type: 'p', text: 'Mở kênh DIDComm, ký thực chứng, chuyển cho bên nắm giữ và lưu vào ví định tín trên thiết bị di động.' }] },
    verification: { title: 'Trình bày và xác minh', blocks: [{ type: 'p', text: 'Gửi yêu cầu trình thực chứng để bên nắm giữ phê duyệt và gửi bản trình bày thực chứng (VP), xác minh bằng chứng mật mã rồi trả lại kết quả.' }] }
  } },
