...
export const PRIVACY_PAGE_TRANSLATIONS: any = {
  en: {
    ...
    outcomeDesc2: 'The company can access the information you submit along with your verification status and related information. However, privacy-preserving credential flows can limit access to that information.',
...
We enforce multi-layered administrative, technical, and physical safeguards designed to comply with FTC Safeguards Rules and GLBA data confidentiality metrics.`
  ...
  vi: {
    ...
    outcomeDesc2: 'Công ty có thể truy cập thông tin bạn gửi cùng trạng thái xác minh và thông tin liên quan. Tuy nhiên, các luồng thực chứng bảo vệ quyền riêng tư có thể giới hạn quyền truy cập này.',
...
PRIVACY_PAGE_TRANSLATIONS.es = {
  ...
  outcomeDesc2: 'La empresa puede acceder a la información que envías junto con tu estado de verificación y datos relacionados. Sin embargo, los flujos de credenciales con privacidad pueden limitar ese acceso.',
...
PRIVACY_PAGE_TRANSLATIONS.ja = {
  ...
  outcomeDesc2: '企業は、送信された情報、確認ステータス、関連情報にアクセスできます。ただし、プライバシーを保護するクレデンシャルフローではアクセスを制限できます。',
...
PRIVACY_PAGE_TRANSLATIONS.de = {
  ...
  outcomeDesc2: 'Das Unternehmen kann auf eingereichte Informationen, Verifizierungsstatus und zugehörige Daten zugreifen. Datenschutzorientierte Credential-Flows können diesen Zugriff jedoch begrenzen.',
