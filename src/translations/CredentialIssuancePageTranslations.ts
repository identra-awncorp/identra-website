  ...
  vi: {
    ...
    journey: {
      ...
      stages: {
        ...
        issue: { eyebrow: '03 · Phát hành', title: 'Ký và chuyển thực chứng theo mô hình phù hợp', description: 'Sử dụng dịch vụ do Identra quản lý hoặc kết nối hạ tầng nằm dưới quyền kiểm soát của bạn.', points: ['Công bố Tài liệu DID qua bộ điều hợp', 'Ưu tiên chuyển thực chứng bằng OpenID4VCI', 'Dùng DIDComm khi hành trình yêu cầu'] },
    ...
    trust: {
      ...
      description: 'Chọn mô hình vận hành phù hợp với trách nhiệm bảo mật mà không làm thay đổi trải nghiệm của bên nắm giữ.',
      ...
      selfManaged: { title: 'Giữ quyền ký trong hạ tầng của bạn', description: 'Kết nối KMS, HSM hoặc bộ ký bên ngoài trong khi Identra điều phối mô-đun, chuyển tới ví và quản lý vòng đời.', points: ['Khóa bí mật không đi qua Identra', 'Kết nối hạ tầng ký được hỗ trợ', 'Chọn did:web, ION hoặc sổ đăng ký nội bộ'] },
    ...
    faq: {
      ...
      items: {
        ...
        custody: { title: 'Ai kiểm soát khóa của bên phát hành?', description: 'Bạn có thể chọn Identra quản lý hoặc kết nối KMS, HSM hay bộ ký bên ngoài để khóa bí mật luôn nằm trong hạ tầng của mình.' },
