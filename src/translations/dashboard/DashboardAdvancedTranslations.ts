...
const vi: DashboardAdvancedCopy = {
  ...
  blockTypes: {
    ...
    consent: 'Chấp thuận',
    credentialRequest: 'Yêu cầu thực chứng',
  ...
  storage: {
    ...
    privacyErrorDescription: 'Workspace đang được mở ở chế độ khôi phục. Hãy xóa giá trị định danh nhập trực tiếp, siêu dữ liệu kiểm thử không an toàn hoặc giá trị bí mật đã lưu trước khi lưu lại.',
