...
WORKFORCE_IDV_PAGE_TRANSLATIONS.vi = {
  ...
  logs: {
    hiring: ["🚀 [Công cụ tuyển dụng] Ứng viên đang gửi giấy tờ...", "🔍 Đang quét định danh tổng hợp và đối chiếu khuôn mặt với video trực tiếp...", "⚠️ Cảnh báo: phân tích nhịp gõ cho thấy đầu vào người dùng tiêu chuẩn. Đạt.", "✨ Thành công: ứng viên David đã được xác minh với AML toàn cầu và watchlist. Độ tin cậy cao."],
    onboarding: ["📥 [Mô-đun onboarding] Nhân viên mới đã chấp nhận. Đang cấp liên kết IDV...", "📱 Đã chụp selfie và xác minh bằng phát hiện liveness 3D nâng cao...", "🔑 Đang ràng buộc token định danh mật mã với khóa phần cứng doanh nghiệp...", "✅ Đã lưu hồ sơ. Webhook ghi danh tự động đã kích hoạt cho Active Directory."],
  ...
  accordions: [
    { id: "library", title: "Thư viện xác minh và tín hiệu mạnh mẽ", columns: [{ title: "Ràng buộc định danh và thiết bị", desc: "Chống deepfake và các loại gian lận khác bằng kiểm tra liveness selfie, xác minh video, ràng buộc thiết bị 2FA và hơn thế nữa." }, { title: "Phạm vi xác minh toàn cầu", desc: "Thu thập và xác minh giấy tờ chính phủ như hộ chiếu, bằng lái từ hơn 200 quốc gia và vùng lãnh thổ." }, { title: "Thiết lập và kiểm tra có thể cấu hình", desc: "Điều chỉnh yêu cầu chất lượng ảnh, phát hiện che khuất khuôn mặt, số lần thử lại và nhiều yếu tố khác theo nhu cầu." }, { title: "Xác minh không dùng giấy tờ", desc: "Kiểm tra PII đã thu và ID số với nguồn phát hành và nguồn có thẩm quyền toàn cầu một cách an toàn." }] },
