...
export const DEMO_SUMMARY_MODAL_TRANSLATIONS: any = {
  "en": {
    ...
    "consensusSealDescription": "Consensus sealed after the configured authority checks passed. Real-time criteria satisfied.",
  ...
  "es": {
    ...
    "consensusSealDescription": "Consenso sellado después de superar las comprobaciones de autoridad configuradas. Criterios en tiempo real satisfechos.",
  ...
  "ja": {
    ...
    "consensusSealDescription": "構成された権限チェックを通過した後、コンセンサスが確定されました。リアルタイム基準を満たしています。",
  ...
  "de": {
    ...
    "consensusSealDescription": "Der Konsens wurde nach bestandenen konfigurierten Autoritätsprüfungen bestätigt. Echtzeitkriterien erfüllt.",
  ...
  "vi": {
    ...
    "consensusSealDescription": "Phán quyết được xác nhận sau khi vượt qua các kiểm tra thẩm quyền đã cấu hình. Các tiêu chí thời gian thực đã đạt.",
    ...
    "highAssuranceSecurityAttestation": "XÁC NHẬN BẢO MẬT ĐỘ ĐẢM BẢO CAO",
    "coreSecureTrustVerdict": "PHÁN QUYẾT TIN CẬY LÕI BẢO MẬT",
    "statusCompliantValid": "TRẠNG THÁI: TUÂN THỦ / HỢP LỆ",
    "identityVerificationPass": "THỰC CHỨNG XÁC MINH DANH TÍNH",
    "certificateDescription": "Bản xác nhận kiểm toán có chữ ký số hoàn tất không có lỗi mặc định hoặc cảnh báo rủi ro cho giao dịch độ đảm bảo cao: {scenario}.",
    "transactionId": "Mã giao dịch",
    "issuingAuthority": "Thẩm quyền cấp",
    "secureCoreVersion": "SecureCore v2.8",
    "attestationWeight": "Trọng số xác nhận",
    "assuranceSuffix": "độ đảm bảo",
    "cryptoProtocol": "Giao thức mật mã",
    "cryptoProtocolValue": "RSA-4096 / SHA-512",
    "digitalCredentialSha256Signature": "CHỮ KÝ SHA-256 CỦA THỰC CHỨNG",
    ...
    "downloadAuditPass": "Tải báo cáo kiểm toán",
...
const APPLY_JOB_IDENTRA_EVIDENCE_DETAILS: LocalizedText[] = [
  ...
  lt(
    ...
    'Sự đồng thuận của ứng viên và phạm vi rà soát được phép đã được ghi nhận. Doanh nghiệp vẫn cần xem xét kết quả theo chính sách tuyển dụng.',
  ),
];
...
const APPLY_JOB_MANUAL_EVIDENCE_DETAILS: LocalizedText[] = [
  ...
  lt(
    ...
    'Thông tin học vấn và đường dẫn chứng chỉ được kiểm tra bằng kết quả giả lập; ứng viên không cung cấp thực chứng kèm bằng chứng mật mã.',
  ),
  lt(
    ...
    'Sự đồng thuận của ứng viên và phạm vi rà soát được phép đã được ghi nhận. Kết quả giả lập vẫn cần doanh nghiệp xem xét.',
  ),
];
...
export const APPLY_JOB_SUMMARY_DATA: ScenarioDecisionData = {
  ...
  rules: [
    ...
    { id: 'RULE-BACKGROUND-CONSENT', name: lt('Consent and permitted screening scope', 'Consentimiento y alcance permitido', '同意および許可された確認範囲', 'Einwilligung und zulässiger Prüfungsumfang', 'Sự đồng thuận và phạm vi rà soát lý lịch'), weight: 0, status: 'PASS' },
  ],
...
export const TICKET_TRANSFER_SUMMARY_DATA: ScenarioDecisionData = {
  ...
  processors: ['TICKET-LEDGER-AUDIT', 'ESCROW-SETTLEMENT-CONTRACT', 'ATOMIC-SETTLE-GRID'],
};
