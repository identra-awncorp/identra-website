  ...
  const LOGOS = {
    openai: (
      <div className="flex items-center gap-2.5">
        ...
        <span className="type-wordmark text-slate-900">OpenAI</span>
      </div>
    ),
    coursera: (
      <div className="flex items-center gap-1">
        <span className="type-wordmark text-[#0056D2]">coursera</span>
      </div>
    ),
    twilio: (
      <div className="flex items-center gap-2">
        ...
        <span className="type-wordmark text-slate-900">twilio</span>
      </div>
    ),
    square: (
      <div className="flex items-center gap-2">
        ...
        <span className="type-wordmark text-slate-900">Square</span>
      </div>
    ),
    lime: (
      <div className="flex items-center gap-2">
        ...
        <span className="type-wordmark text-[#10B981]">Lime</span>
      </div>
    ),
    brex: (
      <div className="flex items-center gap-1.5">
        ...
        <span className="type-wordmark text-slate-900">Brex</span>
      </div>
    ),
    branch: (
      <div className="flex items-center gap-2">
        ...
        <span className="type-wordmark text-slate-800">branch</span>
      </div>
    ),
    wetravel: (
      <div className="flex items-center gap-1">
        <span className="type-wordmark text-[#00A896]">we</span>
        <span className="type-wordmark text-slate-800">travel</span>
      </div>
    ),
    coffeemeetsbagel: (
      <div className="flex items-center gap-1">
        <span className="type-wordmark text-[#1E3A8A]">Coffee</span>
        <span className="type-wordmark text-[#FF7A59]">Meets</span>
        <span className="type-wordmark text-[#1E3A8A]">Bagel</span>
      </div>
    ),
    vestiaire: (
      <div className="flex items-center">
        <span className="type-wordmark text-slate-900 uppercase">Vestiaire Collective</span>
      </div>
    ),
    anton: (
      <div className="flex items-center gap-2">
        ...
        <span className="type-wordmark text-slate-900">Anton Payments</span>
      </div>
    ),
    coinflow: (
      <div className="flex items-center gap-1.5">
        ...
        <span className="type-wordmark text-slate-900">Coinflow</span>
      </div>
    )
  };
  ...
  return (
    <div className="bg-[#FAFBFD] min-h-screen text-slate-800 antialiased font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        <div className="max-w-3xl stack-hero pt-4 pb-12">
          <h1 className="type-page-title text-[#0F1E36]" id="customers_hero_title">
            {t.heroTitle}
          </h1>
          <p className="type-lead text-slate-600 max-w-xl">
            {t.heroDesc}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-12 bg-gradient-to-tr from-[#354CE1] via-[#5F3CF3] to-[#00D4B2] rounded-[32px] p-6 sm:p-10 lg:p-12 relative overflow-hidden shadow-xl flex items-stretch">
            ...
            <div className="w-full lg:max-w-xl bg-white text-slate-950 rounded-[28px] p-8 md:p-12 flex flex-col justify-between space-y-8 shadow-2xl relative z-10">
              ...
              <h2 className="type-section-title-compact text-slate-950">
                {t.featuredOpenAI}
              </h2>
            </div>
          ...
          <div className="lg:col-span-7 bg-[#22C55E] rounded-[32px] p-8 md:p-12 relative overflow-hidden shadow-lg shadow-green-500/5 min-h-[360px] flex flex-col justify-between">
            ...
            <h3 className="type-section-title-compact text-white mt-12">
              {t.featuredCoursera}
            </h3>
          </div>
          ...
          <div className="lg:col-span-5 bg-[#C7D2FE] rounded-[32px] p-8 md:p-12 relative overflow-hidden shadow-lg shadow-indigo-500/5 min-h-[360px] flex flex-col justify-between">
            ...
            <h3 className="type-section-title-compact text-indigo-950 mt-12">
              {t.featuredBrex}
            </h3>
          </div>
          ...
          <div className="lg:col-span-5 bg-[#67E8F9] rounded-[32px] p-8 md:p-12 relative overflow-hidden shadow-lg shadow-cyan-500/5 min-h-[360px] flex flex-col justify-between">
            ...
            <h3 className="type-section-title-compact text-cyan-950 mt-12">
              {t.featuredTwilio}
            </h3>
          </div>
          ...
          <div className="lg:col-span-7 bg-[#FCD34D] rounded-[32px] p-8 md:p-12 relative overflow-hidden shadow-lg shadow-yellow-500/5 min-h-[360px] flex flex-col justify-between">
            ...
            <h3 className="type-section-title-compact text-amber-950 mt-12">
              {t.featuredLime}
            </h3>
          </div>
      ...
      <div className="bg-[#FAFBFD] border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 -mt-10 relative z-20 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="type-caption text-slate-400">{t.refineBy}</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="space-y-1.5 min-w-[200px]">
                  <label className="type-label text-slate-400 uppercase block">{t.industry}</label>
                  <div className="relative">
                    <select
                      ...
                      className="type-control w-full bg-slate-50 border border-slate-200 hover:border-slate-300 text-slate-700 rounded-xl px-3.5 py-2.5 appearance-none focus:outline-none focus:ring-2 focus:ring-[#354CE1]/20 cursor-pointer pr-10"
                    >
                      {INDUSTRIES.map(ind => (
                ...
                {/* Use Case Selector */}
                <div className="space-y-1.5 min-w-[200px]">
                  <label className="type-label text-slate-400 uppercase block">{t.useCase}</label>
                  <div className="relative">
                    <select
          ...
          {/* Heading */}
          <div className="mb-8">
            <h2 className="type-section-title-compact text-slate-900" id="customers_subheading">
              {t.allStoriesTitle}
            </h2>
          ...
          {paginatedStories.length > 0 ? (
              ...
              {paginatedStories.map((story) => (
                ...
                >
                  ...
                  <div className="pt-4 flex flex-wrap gap-1.5 mt-4">
                    <span className="type-caption px-2 py-0.5 bg-slate-100 text-slate-500 rounded-md">
                      {getIndustryLabel(story.industry)}
                    </span>
                    <span className="type-caption px-2 py-0.5 bg-[#354CE1]/5 text-[#354CE1] rounded-md">
            ...
            <div className="bg-white rounded-3xl border border-slate-200/60 p-16 text-center max-w-xl mx-auto space-y-4">
              ...
              <h3 className="type-card-title text-slate-900">{t.noStoriesFound}</h3>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-[#818CF8] text-white rounded-[32px] p-8 md:p-14 lg:p-16 relative overflow-hidden shadow-xl shadow-indigo-950/10">
            ...
            <div className="relative z-10 max-w-2xl space-y-4">
              ...
              <p className="type-body text-indigo-50">
                {t.getInTouch}
              </p>
