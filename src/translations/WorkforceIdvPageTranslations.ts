...
WORKFORCE_IDV_PAGE_TRANSLATIONS.vi = {
  ...
  heroDesc: "Chặn kỹ nghệ xã hội, deepfake và giả mạo ở mọi giai đoạn vòng đời nhân viên. Bảo vệ hệ thống bằng quy trình xác minh danh tính dựa trên mật mã.",
  consultationCta: "Nhận tư vấn cho Workforce",
  candidateCta: "Đi tới xác minh ứng viên",
  ledgerTitle: "Sổ cái định danh nhân viên",
  ledgerDesc: "Bảo vệ thông tin định danh doanh nghiệp liên tục",
  secured: "ĐÃ BẢO VỆ",
  ...
  phone: {
    ...
    routeDesc: "Thông tin định danh đã được đồng bộ với Active Directory của doanh nghiệp. Khóa phần cứng đã được liên kết.",
