...
export const MANUAL_REVIEW_PAGE_TRANSLATIONS = {
  ...
  es: {
    ...
    cta: { title: '¿Listo para empezar?', desc: 'Contacta con nosotros o empieza a explorar Identra hoy. Conecta módulos de validación y coordina tu mesa de revisión.', tryDemo: 'Probar la demo', tryNow: 'Probar ahora' }
  },
  ja: {
    hero: { badge: '手動レビューのユースケース', title: '最適化された手動レビューで意思決定を迅速化。', desc: '日常的なレビューから難しい不正ケースまで、速度と精度を高める調査ハブで対応できます。', tryDemo: 'デモを試す', backToPlatform: 'プラットフォームに戻る', stats: [{ value: '45%', label: '手動負荷を削減', desc: '自動キュートリアージと条件付きルール割り当てによって実現。' }, { value: '< 3分', label: '平均ケース解決時間', desc: 'アクティブ、パッシブ、AML 指標を1つのビューに統合。' }] },
  ...
  vi: {
    ...
    cta: { title: 'Sẵn sàng bắt đầu?', desc: 'Liên hệ hoặc bắt đầu khám phá Identra hôm nay. Kết nối mô-đun xác thực tùy chỉnh và điều phối bàn rà soát liền mạch.', tryDemo: 'Trải nghiệm demo', tryNow: 'Thử ngay' }
  }
} as const;
