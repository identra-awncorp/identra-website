...
export const BANK_ACCOUNT_DEMO_PAGE_TRANSLATIONS: any = {
  "en": {
    ...
    "scenario": {
      ...
      "identraVcClaimNotice": "Scan the QR code below to receive your card as a Verifiable Credential directly into your SSI wallet.",
    ...
    "flowUi": {
      ...
      "vcBadgeLabel": "Identra SSI Verifiable Credential",
  ...
  "es": {
    ...
    "flowUi": {
      ...
      "vcBadgeLabel": "Credencial verificable SSI de Identra",
  ...
  "ja": {
    ...
    "flowUi": {
      ...
      "vcBadgeLabel": "Identra SSI検証可能資格情報",
  ...
  "vi": {
    ...
    "flowUi": {
      ...
      "vcBadgeLabel": "Thực chứng được Identra tạo ra",
