...
export default function FinancialInstitutionsPage({ onOpenSandbox, onBackToLanding, onViewChange }: FinancialInstitutionsPageProps) {
  ...
  const activePanelTitle = 'panelTitle' in activeTabData ? activeTabData.panelTitle : '';
  const activePanelStatus = 'panelStatus' in activeTabData ? activeTabData.panelStatus : '';
